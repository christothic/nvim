...
M.SetupKeys = function()
    ...
    vim.keymap.set({ 'n' }, "<leader>fa",
        ":lua require('telescope').extensions.live_grep_args.live_grep_args()<cr>\"\" --iglob *.",
    ...
    vim.keymap.set({ 'n', 't' }, "<c-\\><c-\\>", "<C-\\><C-n>:FloatermToggle<cr>", { desc = "FzF Floating Terminals", })
    vim.keymap.set({ 't' }, "<c-\\><c-n>", "<C-\\><C-n>:FloatermNew<cr>", { desc = "FzF Floating Terminals", })
    vim.keymap.set({ 't' }, "<c-\\><c-[>", "<C-\\><C-n>:FloatermNext<cr>", { desc = "FzF Floating Terminals", })
    vim.keymap.set({ 't' }, "<c-\\><c-]>", "<C-\\><C-n>:FloatermPrev<cr>", { desc = "FzF Floating Terminals", })
